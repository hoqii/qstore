...
<#assign cssAdditional="docs.css">
	...
	<link rel="stylesheet" href="${base}/static/bootstrap/css/datepicker.css" type="text/css"/>
	<script type="text/javascript" src="${base}/static/bootstrap/js/bootstrap-datepicker.js"></script>